...
export default function Main() {
    ...
    return (
        <div className='h-fit w-screen' id='main-container'>
            <div className='top-0 right-0 relative' id='top'></div>

            <section className="flex flex-row fixed z-50 w-screen h-[12vh] backdrop-blur-sm">
            ...
            <section className='h-[100vh] w-screen fixed z-20 flex align-items-center justify-center overscroll-x-hidden'>
            ...
            <section className='w-screen h-fit absolute mt-[100vh] pb-[5vh] bg-[#0d0d0d] rounded-[80px] z-30 flex flex-row border-2 border-white'>
                ...
                <div>
                    ...
                    <h1 className='relative left-[22vw] mt-24 text-3xl w-[55vw] text-left text-white' id='second'>We are a collective of experienced creatives drawn to the imperfections of chemical film, vintage lenses, and nostalgic set pieces. 
                        Aberration was formed because we discovered a shared passion for exploring the human experience with video production. 
                    </h1>
                    <h1 className='relative left-[22vw] mt-32 text-3xl w-[55vw] text-left text-white' id='third'>
            ...
            <div className='w-screen h-[40vh] absolute mt-[200vh] bg-[#0d0d0d] z-20 align-center justify-center flex overflow-hidden'>
                <div className='flex flex-row opacity-60 justify-center align-center space-x-2 overflow-hidden'>
                    <img src={abe_grid} alt="Aberration Background" className='relative h-[95vh] w-screen mt-[2.5vh]' id='abe_grid'></img>
                    <img src={abe_grid} alt="Aberration Background" className='relative h-[95vh] w-screen mt-[2.5vh]' id='abe_grid'></img>
                    <img src={abe_grid} alt="Aberration Background" className='relative h-[95vh] w-screen mt-[2.5vh]' id='abe_grid'></img>
                    <img src={abe_grid} alt="Aberration Background" className='relative h-[95vh] w-screen mt-[2.5vh]' id='abe_grid'></img>
                </div>
            ...
            <section className='w-screen h-[60vh] absolute mt-[234vh] pb-[13vh] bg-[#0d0d0d] rounded-[80px] z-30 border-2 border-white'>
                ...
                <div className='w-fit flex flex-col justify-center relative left-[22vw] space-y-16'>
                    <div className='relative h-fit w-fit'>
                        <h1 className='relative text-white text-[4vw] mt-[6vh] left-[6.5vw]' id='trusted'>Our Team Is Trusted By</h1>
                    </div>
                    <div className='flex flex-col space-y-4 justify-center relative' id='big_boys'>
                        <div className='relative flex flex-row w-[60vw] h-fit space-x-96 justify-center align-center right-10'>
                            <img src={disney} alt='Disney' className='h-[8vh] w-[9vw]'></img>
                            <img src={apple} alt='Apple' className='h-[6vh] w-[3vw]'></img>
                            <img src={sony} alt='Sony' className='relative h-[16vh] w-[7vw] bottom-10'></img>
                        </div>
                        <div className='relative flex flex-row w-[60vw] h-fit space-x-56 justify-center align-center right-7'>
            ...
            <section className='w-fit h-fit absolute mt-[296vh] pb-[20vh] bg-transparent z-30' id='contact'>
                ...
                <div className='relative flex flex-row w-[60vw] h-fit space-x-20 justify-center align-center pt-[15vh] left-[20vw]'>
                    <a href='https://tfetn9etlwo.typeform.com/to/hPE8Baza' rel="noopener noreferrer" target="_blank" className='group' >
                        <div className='rounded-[80px] relative bg-white w-60 h-20 flex flex-row justify-center group-hover:bg-[#0d0d0d] border-2 border-white transition duration-200' id='button'>
                            <h1 className='pt-[2.5vh] text-2xl group-hover:text-white transition duration-200'>Contact Us</h1>
                        </div>
                    </a>
                </div>
                <div className='flex flex-row w-fit relative mt-[13vh] justify-center align-center space-x-60 left-[30.5vw]'>
                    <div className='h-fit w-fit'>
                        <h1 className='text-white text-[2vw]'>310.650.1052</h1>
                    </div>
                    <div className='h-fit w-fit'>
                        <h1 className='text-white text-[2vw]'>Nashville, TN USA</h1>
                    </div>
                </div>
            </section>
